 ...
 * <p/>
 * <p><em>For {@link ListView} list items that don't manage their own touch events (i.e. you're
 * using {@link ListView#setOnItemClickListener(AdapterView.OnItemClickListener)} or an equivalent
 * listener on {@link ListActivity} or {@link ListFragment}, use {@link
 * SwipeDismissRecyclerViewTouchListener} instead.</em></p>
 * <p/>
 * <p>Example usage:</p>
 * <p/>
 * <pre>
...
public class SwipeDismissTouchListener implements View.OnTouchListener {
	 ...
	 * @param callbacks
	 * 		The callback to trigger when the user has indicated that she would like to dismiss this
	 * 		view.
	 */
		...
		switch (motionEvent.getActionMasked()) {
			...
			case MotionEvent.ACTION_MOVE: {
				...
				if (mSwiping) {
					...
					setTranslationX(mView, deltaX - mSwipingSlop);
