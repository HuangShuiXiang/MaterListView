 ...
 */
package com.materlistview.util;
...
public class AbViewUtil {
    ...
    public static final String NotScale="NotScale";
	/**
	...
	public static boolean isNeedScale(View view){
		if (view.getTag()!=null && view.getTag().toString().equals(NotScale)) {
			return false;
		}
		return true;
	}
